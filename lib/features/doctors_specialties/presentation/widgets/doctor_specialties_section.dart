...
import 'package:medora/features/doctors_specialties/presentation/widgets/specialty_card.dart'
    show SpecialtyCard;
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => SpecialtyCard(
          ...
          onTap: () {
            print(
              'DoctorSpecialtiesSection.xxxxxxxxxxxxx ${medicalSpecialties[index].name}',
            );
