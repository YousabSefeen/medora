...
import 'package:medora/features/payment_gateways/paymob/presentation/controller/states/paymob_payment_state.dart'
    show PaymobPaymentState;
import 'package:medora/features/payment_gateways/shared/actual_web_view_controller_navigator.dart';
import 'package:medora/features/payment_gateways/shared/screens/web_view_payment_screen_mixin.dart'
    show WebViewPaymentScreenMixin;
...
class _PaymobPaymentScreenState extends State<PaymobPaymentScreen>
  ...
  String get screenTitle =>
      widget.selectedPaymentMethod == PaymentGatewaysTypes.paymobMobileWallets
      ? AppStrings.mobileWallets
      : AppStrings.onlineCard;
