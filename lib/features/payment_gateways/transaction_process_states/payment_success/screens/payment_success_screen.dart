...
import 'package:medora/features/payment_gateways/transaction_process_states/payment_success/widgets/appointment_details_success_card.dart' show AppointmentDetailsSuccessCard;
import 'package:medora/features/payment_gateways/transaction_process_states/payment_success/widgets/bottom_action_button_section.dart' show BottomActionButtonSection;
import 'package:medora/features/payment_gateways/transaction_process_states/payment_success/widgets/custom_check_icon.dart' show CustomCheckIcon;
import 'package:medora/features/payment_gateways/transaction_process_states/payment_success/widgets/custom_dashed_line_divider.dart' show CustomDashedLineDivider;
import 'package:medora/features/payment_gateways/transaction_process_states/payment_success/widgets/custom_payment_success_message.dart' show CustomPaymentSuccessMessage;
...
class PaymentSuccessScreen extends StatelessWidget {
  ...
  void _navigateToDoctorList (BuildContext context) => AppRouter.pushAndRemoveUntil(context,const DoctorListViewScreen());
