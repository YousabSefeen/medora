...
import 'package:medora/features/payment_gateways/paypal/transaction_process_states/presentation/widgets/paypal_payment_method_info.dart'
    show PaypalPaymentMethodInfo;
import 'package:medora/features/payment_gateways/stripe/transaction_process_states/view/payment_success/presentation/widgets/stripe_payment_method_info.dart'
    show StripePaymentMethodInfo;
...
class PaymentMethodDetails extends StatelessWidget {
  ...
  const PaymentMethodDetails({super.key, required this.paymentMethod});
