...
import 'package:medora/core/payment_gateway_manager/paypal_payment/paypal_dummy_data_service.dart'
    show PaypalDummyDataService;
import 'package:medora/core/payment_gateway_manager/paypal_payment/paypal_keys.dart'
    show PaypalKeys;
import 'package:medora/features/payment_gateways/paypal/transaction_process_states/data/models/paypal_payment_response_model.dart'
    show PaypalPaymentResponseModel;
import 'package:medora/features/payment_gateways/transaction_process_states/payment_failed/screens/payment_failed_screen.dart'
    show PaymentFailedScreen;
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: PaypalCheckoutView(
          ...
          transactions: [PaypalDummyDataService.paypalPaymentTransactionModel],
