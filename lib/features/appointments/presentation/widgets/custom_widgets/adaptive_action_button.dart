...
class AdaptiveActionButton extends StatelessWidget {
  ...
  const AdaptiveActionButton({super.key, required this.title, required this.isEnabled, required this.onPressed, required this.isLoading});
  ...
  ButtonStyle _getButtonStyle(bool isEnabled) {
    return ButtonStyle(
      ...
      foregroundColor:
      WidgetStatePropertyAll(isEnabled ?  Colors.white: Colors.black ),
    );
  }
