...
abstract class AppointmentRepositoryBase {
  ...
  fetchUpcomingAppointments({required PaginationParameters parameters});

  Future<Either<Failure, PaginatedDataResponse<ClientAppointmentsEntity>>>
  fetchCompletedAppointments({required PaginationParameters parameters});

  Future<Either<Failure, PaginatedDataResponse<ClientAppointmentsEntity>>>
  fetchCancelledAppointments({required PaginationParameters parameters});
