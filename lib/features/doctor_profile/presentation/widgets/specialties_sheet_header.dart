...
class SpecialtiesSheetHeader extends StatelessWidget {
  ...
  const SpecialtiesSheetHeader(
      {super.key, required this.onChanged, required this.lastSearchTerm});
  ...
  Expanded _specialtySearchField(BuildContext context,
      void Function(String) onChanged) =>
      Expanded(
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical:10),
        child: SizedBox(
          child: TextFormField(style: Theme.of(context).textTheme.styleInputField.copyWith(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: Theme.of(context).textTheme.hintFieldStyle.copyWith(
