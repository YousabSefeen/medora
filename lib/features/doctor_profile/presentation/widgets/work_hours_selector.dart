...
import 'package:medora/features/doctor_profile/presentation/widgets/work_hours_range_display.dart'
    show WorkHoursRangeDisplay;
...
class WorkHoursSelector extends StatelessWidget {
    ...
    if (workHoursSelected.isEmpty) {
      return AnimatedFadeTransition(
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.hintFieldStyle.copyWith(fontWeight: FontWeight.w400),
        ),
      );
    } else {
  ...
  Widget _buildTimeRangePicker(bool isWorkHoursExpanded) =>
      TimeRangePicker(isWorkHoursExpanded: isWorkHoursExpanded);
}
