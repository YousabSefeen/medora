...
class SpecialtiesListViewSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  KeyboardVisibilityBuilder(
      builder: (context, isKeyboardVisible) =>   ConstrainedBox(
          ...
          child: BlocSelector<DoctorProfileCubit, DoctorProfileState,
              Tuple2<List<String>, List<String>>>(
            selector: (state) => Tuple2(
                state.filteredSpecialties, state.selectedSpecialtiesTempList),
              ...
              child: ListView.builder(
               padding: const EdgeInsets.only(bottom:  100),
                ...
                itemBuilder: (context, index) {
                  ...
                  final isAlreadySelected = values.value2.contains(specialties);
                  return CustomCheckboxTile(
                    ...
                    onChanged: (value) {
                      ...
                      if (!cubit.canSelectMoreSpecialties &&
                        ...
                        cubit
                            .toggleMedicalSpecialties(specialties);
                      }
                    },
                  );
                },
  ...
  _buildConstrainedBox(BuildContext context,bool isKeyboardVisible,Widget child){
    ConstrainedBox(
        constraints: BoxConstraints(
          minHeight:isKeyboardVisible? double.infinity :  MediaQuery.sizeOf(context).height * 0.75,
          maxHeight: isKeyboardVisible? double.infinity :  MediaQuery.sizeOf(context).height * 0.75,
        ),
        child:child);

        }
  void _showSpecialtyLimitAlert(BuildContext context) => AppAlerts.showTopSnackBarAlert(
        context: context,
