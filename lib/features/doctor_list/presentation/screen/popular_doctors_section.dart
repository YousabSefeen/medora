...
import 'package:medora/features/shared/domain/entities/doctor_entity.dart'
    show DoctorEntity;
import 'package:medora/features/shared/presentation/screens/sliver_pagination_screen_mixin.dart' show SliverPaginationScreenMixin;
...
class _PopularDoctorsSectionState extends State<PopularDoctorsSection>
  ...
  @override
  void initState() {
    // ربط الـ Controller الخارجي (هام: قبل super.initState())
