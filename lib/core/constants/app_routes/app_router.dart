...
class AppRouter {
  ...
  static Future<Null> pushNamed(BuildContext context, String screenName,
          {Object? arguments, FutureOr<dynamic> Function(Object?)? onResult}) =>
  ...
  static void push(BuildContext context, Widget screen ,
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
      screen,settings: RouteSettings(arguments: arguments),
  ...
  static Future<Object?> pushNamedAndRemoveUntil(BuildContext context, String screenName,
          {Object? arguments ,bool isReplacement = false}) =>
  ...
  static Future pushAndRemoveUntil(BuildContext context, Widget screen,
      {Object? arguments}) => Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
